...
@implementation ReportUrinalysis
...
@synthesize dataField10;
@synthesize dataField11;
@synthesize dataField12;
@synthesize patient;
@synthesize report;
...
- (void)viewDidUnload
{
    ...
    [self setDataField10:nil];
    [self setDataField11:nil];
    [self setDataField12:nil];
    [super viewDidUnload];
...
- (IBAction)save:(id)sender
{
    ...
    self.report.d10 = self.dataField10.text;
    self.report.d11 = self.dataField11.text;
    self.report.d12 = self.dataField12.text;
    ...
    [self.delegate saveUrinalysisReport:patient];
